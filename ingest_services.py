...
KNOWLEDGE_FILES: list[dict[str, Any]] = [
    ...
    {
        "filename": "s3_express_one_zone.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "storage",
        "document_type": "storage_architecture",
        "title": "Amazon S3 Express One Zone (High-Performance Single-AZ Object Storage)",
    },
    {
        "filename": "bedrock_agentcore.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "ai",
        "document_type": "ai_agent_architecture",
        "title": "Amazon Bedrock AgentCore & Guardrails (ReAct Agents, OpenAPI Action Groups)",
    },
    {
        "filename": "eks_auto_mode.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "kubernetes",
        "document_type": "kubernetes_architecture",
        "title": "Amazon EKS Auto Mode (Fully Managed Compute, Storage & CNI)",
    },
    {
        "filename": "graviton4.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "compute",
        "document_type": "compute_architecture",
        "title": "AWS Graviton4 Processors (R8g / C8g Arm Neoverse V2 Architecture)",
    },
    {
        "filename": "trainium2.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "ai",
        "document_type": "ai_compute_architecture",
        "title": "AWS Trainium2 & Trn2 UltraClusters (Distributed AI Pre-Training)",
    },
    {
        "filename": "amazon_q_developer.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "ai",
        "document_type": "ai_developer_tool",
        "title": "Amazon Q Developer (CLI, IDE Agents, Code Transformation)",
    },
    {
        "filename": "axion_processors.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "compute",
        "document_type": "compute_architecture",
        "title": "Google Cloud Axion Processors (C4A Arm Neoverse V2 Compute)",
    },
    {
        "filename": "vertex_ai_reasoning_engine.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "ai",
        "document_type": "ai_agent_architecture",
        "title": "Google Cloud Vertex AI Reasoning Engine (Managed Agent Runtime)",
    },
    {
        "filename": "hyperdisk_ml.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "storage",
        "document_type": "storage_architecture",
        "title": "Google Cloud Hyperdisk ML (Multi-Reader AI Storage)",
    },
    {
        "filename": "alloydb_omni.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "database",
        "document_type": "database_architecture",
        "title": "Google Cloud AlloyDB Omni (PostgreSQL Hybrid Columnar Engine)",
    },
    {
        "filename": "container_apps_dynamic_sessions.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "serverless",
        "document_type": "serverless_architecture",
        "title": "Azure Container Apps Dynamic Sessions (Sandboxed MicroVM Code Execution)",
    },
    {
        "filename": "cobalt_100.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "compute",
        "document_type": "compute_architecture",
        "title": "Microsoft Azure Cobalt 100 Processors (128-Core Arm Neoverse N2)",
    },
    {
        "filename": "maia_100.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "ai",
        "document_type": "ai_compute_architecture",
        "title": "Microsoft Azure Maia 100 AI Accelerator (Liquid-Cooled AI Silicon)",
    },
    {
        "filename": "cilium_ebpf.md",
        "namespace_base": "senior-engineer-knowledge",
        "domain": "networking",
        "document_type": "networking_architecture",
        "title": "CNCF Cilium & eBPF Networking & Security (Sidecarless Service Mesh)",
    },
]
